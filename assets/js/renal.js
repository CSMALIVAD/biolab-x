...
/* Output */
let outputHTML = `
<div style="background:#0f172a;padding:15px;border-radius:10px;margin-bottom:15px;color:white;">
<div style="font-size:20px;color:#38bdf8;font-weight:bold;">
CKD-EPI 2021: ${egfr_ckd.toFixed(1)} mL/min/1.73m²
</div>
<div>Stage: ${stage(egfr_ckd)}</div>
</div>

<div style="background:#1e293b;padding:15px;border-radius:10px;margin-bottom:15px;color:white;">
<p>MDRD: ${egfr_mdrd.toFixed(1)}</p>
<p>Cockcroft–Gault (CrCl): ${crcl.toFixed(1)}</p>
...
data:[egfr_ckd, egfr_mdrd, crcl, egfr_bis],
backgroundColor:[
'#38bdf8',
'#84cc16',
'#facc15',
